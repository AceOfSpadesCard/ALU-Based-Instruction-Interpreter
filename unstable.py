...
class Register:
    ...
    def Write(self, Register, Data, Overwrite):
        #if Register != None:
            #if Overwrite == "Y":
...
while Exit != True:
    ...
    # The section for register operations
        ...
        if RegisterInput[0:5] == "WRITE":
            OverWriteQuestion = input("OverWriteContent? ")
            RegisterOutput = RegisterControl.Write(RegisterInput[6:16], RegisterInput[17:], OverWriteQuestion)
